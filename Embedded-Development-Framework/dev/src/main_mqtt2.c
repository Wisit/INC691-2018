...
void WiFi_LineReceived(void *evt) {
    ...
    /***************************************************************************/
        ...
        COM_SendString("\r\nLine Received: ");
        COM_SendBytes(line->data, line->length);
    #endif
    ...
    if(-1 != str_raw_index_of_first_token((char *)line->data, line->length, (char *)"OK\r\n")) {
        #ifdef LINE_RECEIVED_DEBUG
            COM_SendString("\r\nToken OK received\r\n");
        #endif
    ...
    else if(-1 != str_raw_index_of_first_token((char *)line->data, line->length, (char *)"ERROR\r\n")) {
        #ifdef LINE_RECEIVED_DEBUG
    ...
    else if(-1 != str_raw_index_of_first_token((char *)line->data, line->length, (char *)"WIFI DISCONNECT\r\n")) {
        wifi_state = WIFI_STATS_DISCONNECTED;
    }
    else if(-1 != str_raw_index_of_first_token((char *)line->data, line->length, (char *)"WIFI CONNECTED\r\n")) {
        wifi_state = WIFI_STATS_DISCONNECTED;
    }
    else if(-1 != str_raw_index_of_first_token((char *)line->data, line->length, (char *)"WIFI GOT IP\r\n")) {
    ...
    /***************************************************************************/
    else if(-1 != str_raw_index_of_first_token((char *)line->data, line->length, (char *)"CONNECT\r\n")) {
        mqtt_state = MQTT_STATE_CONNECTED;
    }
    else if(-1 != str_raw_index_of_first_token((char *)line->data, line->length, (char *)"CLOSED\r\n")) {
        mqtt_state = MQTT_STATE_DISCONNECTED;
    }
        
    else if(-1 != str_raw_index_of_first_token((char *)line->data, line->length, (char *)"+IPD,")) { /* !! No \r\n*/
