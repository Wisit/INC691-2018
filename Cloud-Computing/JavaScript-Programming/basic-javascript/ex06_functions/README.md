## ex06_functions
This example demonstrates how to write and use many styles of ***function*** in JavaScript. A function in JavaScript and other programming languages is a block of code that written to do something specifically. The function can be reused and can be called from anywhere from our program.
