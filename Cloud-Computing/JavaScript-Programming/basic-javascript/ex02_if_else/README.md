## ex02_if_else
This example demonstrates how to use ***if***, ***else*** and ***else if*** to control program flow. Some simple condition checking, multiple conditions checking and variable types checking are also provided.
